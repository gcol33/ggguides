...
|----|----|
| [`legend_left()`](https://gcol33.github.io/ggguides/reference/legend_left.md) | Left position with proper alignment |
| [`legend_right()`](https://gcol33.github.io/ggguides/reference/legend_right.md) | Right position with proper alignment |
...
| [`legend_none()`](https://gcol33.github.io/ggguides/reference/legend_none.md) | Remove legend |

### Direction Helpers

| Function | Description |
|----|----|
| [`legend_horizontal()`](https://gcol33.github.io/ggguides/reference/legend_horizontal.md) | Horizontal legend direction |
| [`legend_vertical()`](https://gcol33.github.io/ggguides/reference/legend_vertical.md) | Vertical legend direction |
...
| [`legend_reverse()`](https://gcol33.github.io/ggguides/reference/legend_reverse.md) | Reverse legend order |
...
No cowplot dependency. Users needing cowplot integration should use the
lemon package.
