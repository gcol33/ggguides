...
Expand ggguides from a legend-focused package to a **comprehensive guide
toolkit** that simplifies all common guide operations in ggplot2 -
legends, colorbars, and axes.

## Phase 1: Legend Enhancements (Priority)

### 1.1 Legend Order Control

**Pain point:** Multiple competing methods to reorder legends (factor
levels, breaks, guide_legend, forcats)
...
Ensure position helpers work with colorbars

Add colorbar vignette section
...
2.  **Sensible defaults** - Works out of the box, customizable when
    needed
3.  **Composable** - All functions work together with `+`
4.  **Discoverable** - Consistent naming (`legend_*`, `colorbar_*`,
    `axis_*`)
